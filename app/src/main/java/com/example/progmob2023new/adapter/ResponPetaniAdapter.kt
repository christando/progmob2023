...
import com.example.progmob2023new.CRUD.GetpetaniActivity
import com.example.progmob2023new.CRUD.UpdatePetaniActivity
import com.example.progmob2023new.Network.NetworkConfig
import com.example.progmob2023new.R
import com.example.progmob2023new.model.Petani
import com.example.progmob2023new.model.ResponseAddPetani
import com.google.android.gms.wearable.DataItem
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
class ResponPetaniAdapter(var petani: List<DataItem>?):RecyclerView.Adapter<ResponPetaniAdapter.PetaniHolder>(){
    lateinit var mContext: Context
    lateinit var adapter: ResponPetaniAdapter

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ResponPetaniAdapter.PetaniHolder {
        return PetaniHolder(LayoutInflater.from(parent.context).inflate(R.layout.rv_item_petani, parent, false))
    }

    override fun onBindViewHolder(holder: ResponPetaniAdapter.PetaniHolder, position: Int) {
